...
from diffusion.base import GenerativeType
...
def imagenet256_autoenc():
    ...
    conf.net_ch_mult = (1, 1, 2, 2, 4, 4)
    conf.net_enc_channel_mult = (1, 1, 2, 2, 4, 4, 4)
    conf.eval_every_samples = 400_000
    conf.eval_ema_every_samples = 400_000
    conf.total_samples = 200_000_000
    conf.batch_size = 64
    conf.make_model_conf()
    ...
    conf.classes = list(range(151, 201))
    conf.n_samples = None
    conf.cache_dir = "/mnt/evafs/groups/mi2lab/ljaremek"
