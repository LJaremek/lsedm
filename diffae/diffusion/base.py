...
Docstrings have been added, as well as DDIM sampling and
a new collection of beta schedules.
"""
...
from model.nn_custom import mean_flat
from config_base import BaseConfig
from choices import (
    GenerativeType, ModelType, ModelMeanType, ModelVarType, LossType
)
...
class GaussianDiffusionBeatGans:
    ...
    def ddim_reverse_sample_loop(
        ...
        return {
            ...
            # (1, ..., T)
            'sample_t': sample_t,
            # xstart here is a bit different from sampling
            #   from T = T-1 to T = 0
            # may not be exact
            'xstart_t': xstart_t,
            'T': T,
    ...
    def calc_bpd_loop(self,
        ...
        :return: a dict containing the following keys:
                 - total_bpd: the total variational lower-bound,
                    per batch element.
