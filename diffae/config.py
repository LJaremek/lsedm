...
from model.latent_net import LatentNetType
...
from model.latent_net import MLPSkipNetConfig
from choices import (
    TrainMode, ManipulateMode, ManipulateLossType, OptimizerType, ModelName,
    ModelType, Activation
)
from model import ModelConfig
from multiprocessing import get_context
import os
from dataset_util import use_cached_dataset_path
...
class TrainConfig(BaseConfig):
    ...
    def fid_cache(self):
        ...
        msg = f"{self.work_cache_dir}/eval_images/{self.data_name}_size"
        msg += f"{self.img_size}_{self.eval_num_images}"
        return msg
